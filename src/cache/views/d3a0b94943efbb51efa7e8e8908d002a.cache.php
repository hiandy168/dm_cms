...
<!--<div class="col-2 col-auto">
	...
	<div class="content" style="height:170px;">
        ...
        <table border="0">
            <tr>
                <td width="60">
                    <img src="http://www1.dayrui.com/assets/wx.png" width="55" height="55">
                </td>
                <td>
                    <p>用微信扫描二维码，关注“天睿云计算” </p>
                    <p>获取FineCMS最新研发动态，每日免费送短信！ </p>
                </td>
            </tr>
        </table>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
    <td colspan="2">
        <p style="line-height:25px"><a href="http://cloud.dayrui.com" target="_blank" style="color:blue">FineCMS专用虚拟主机优惠活动开始啦，官网注册会员可享有：</a></p>
        <p style="line-height:20px"><a href="http://cloud.dayrui.com/services/webhosting/linux_host.asp" target="_blank" style="color:blue">专用国内虚拟主机最低99元/年</a>
            &nbsp;&nbsp;
        <a href="http://cloud.dayrui.com/services/webhosting/linux_host.asp" target="_blank" style="color:blue">专用香港免备案主机最低94元/年</a></p>
    </td>
    </tr>
	</table>
	</div>
